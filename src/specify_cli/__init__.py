...
def download_and_extract_template(project_path: Path, ai_assistant: str, script_type: str, is_current_dir: bool = False, *, verbose: bool = True, tracker: StepTracker | None = None, client: httpx.Client = None, debug: bool = False, github_token: str = None) -> Path:
    ...
    if env_zip:
        ...
        cleanup_required = False  # never delete user-provided archive
        zip_path = candidate
        meta = {
            "filename": candidate.name,
            "size": candidate.stat().st_size,
            "release": "ENV-OVERRIDE",
            "asset_url": str(candidate),
        }
        if tracker:
            tracker.start("fetch", "SPECIFY_TEMPLATE_ZIP override")
            tracker.complete("fetch", candidate.name)
    ...
    try:
        ...
        if cleanup_required:
            ...
            if tracker:
                tracker.add("cleanup", "Remove temporary archive")
                tracker.complete("cleanup", "SPECIFY_TEMPLATE_ZIP override")
...
def init(
    ...
    Examples:
        ...
        specify-ext init my-project --ai kilocode
        specify-ext init my-project --ai auggie
        specify-ext init my-project --ai codebuddy
        specify-ext init my-project --ai q
        ...
        specify-ext init --here --ai codebuddy
        specify-ext init --here
    ...
    enhancement_lines = [
        ...
        f"○ [cyan]/speckit.audit[/] [bright_black](optional)[/bright_black] - Run the governance-focused review playbook to enforce policy and control gates (after [cyan]/speckit.implement[/])",
        f"○ [cyan]/speckit.changelog[/] [bright_black](optional)[/bright_black] - Prepare a detailed changelog entry and detect system documentation drift (after [cyan]/speckit.implement[/] or [cyan]/speckit.audit[/])",
    ]
